...
router.get('/add', authController.isLogged, storeController.addStore);
...
router.get('/hearts', authController.isLogged, catchErrors(storeController.getHearts));
...
router.post('/api/stores/:id/heart', catchErrors(storeController.storeHearts));
