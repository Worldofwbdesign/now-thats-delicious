...
exports.default = function (search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      if (res.data.length) {
        searchResults.innerHTML = _dompurify2.default.sanitize(showResultsHTML(res.data));
        return;
      }

      searchResults.innerHTML = _dompurify2.default.sanitize('\n          <div class="search__result">No results for ' + _this.value + '</div>\n        ');
    });
  });
  ...
  searchInput.on('keyup', function (e) {
    ...
    var results = document.querySelectorAll('.search__result');
    var next = void 0;
...
var showResultsHTML = function showResultsHTML(stores) {
...
var _hearts = __webpack_require__(39);
